...
user_prediction[user_prediction < 0.1] = 0
item_prediction[item_prediction < 0.1] = 0
print(np.nonzero(item_prediction))


print(item_prediction[0:8])

user_prediction2 = np.copy(user_prediction)
item_prediction2 = np.copy(item_prediction)
test_data_matrix2 = np.copy(test_data_matrix)
print(item_prediction[0:8])
...
print('User-based CF RMSE based on test_nonzero: ' + str(rmse(user_prediction, test_data_matrix)))
print('Item-based CF RMSE based on test_nonzero: ' + str(rmse(item_prediction, test_data_matrix)))
print(item_prediction[0:8])

print(np.nonzero(item_prediction2))
print(np.nonzero(test_data_matrix2))
print(np.nonzero(user_prediction2))

print('User-based CF RMSE based on pred_nonzero: ' + str(rmse(test_data_matrix2, user_prediction2)))
print('Item-based CF RMSE based on pred_nonzero: ' + str(rmse(test_data_matrix2, item_prediction2)))
print(item_prediction[0:8])